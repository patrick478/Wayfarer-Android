...
package com.SteelAmbition.Wayfarer.crouton;
 ...
 * <p/>
 * <b>Important: </b>
 * Call {@link Crouton#clearCroutonsForActivity(android.app.Activity)} within
...
public final class Crouton {
   ...
   *
   * @param activity
   *   The {@link android.app.Activity} that the {@link Crouton} should be attached
   *   to.
   * @param text
   ...
   *   The style that this {@link Crouton} should be created with.
   * @param viewGroup
   *   The {@link android.view.ViewGroup} that this {@link Crouton} should be added to.
   */
   ...
   *   The resource id of the {@link android.view.ViewGroup} that this {@link Crouton} should be added to.
   *
   * @return The created {@link Crouton}.
   */
  ...
  /**
   * Allows setting of an {@link android.view.View.OnClickListener} directly to a {@link Crouton} without having to use a custom view.
   *
